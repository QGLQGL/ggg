...
train = pd.read_csv("G:\\BaiduNetdiskDownload\\百度云文件下载\\python培训课课件等\\11.02\作业\\subset_train.csv")
test = pd.read_csv("G:\\BaiduNetdiskDownload\\百度云文件下载\\python培训课课件等\\11.02\作业\\Small_test.csv")
...
# timsteps = 32/28都可以
model = Sequential()                                 
model.add(SimpleRNN(128, input_shape = input_shape, return_sequences=True))       # 28个时间节点的，28个维    
model.add(Dropout(0.3))           # 舍弃百分之30
